...
@Component({
  ...
  styleUrl: './management3.component.css'
})
export class Managament3Component {
...
getManagementDataById(patientId: number,stage:number) {
  const url = `https://gerdregistryofindia.com/GERD/api/Management/GetManagementById/${this.patientService.getPatientId()}/${stage}`;
