  ...
  public class InCompletedReportController : Controller
  {
    ...
    public async Task<IActionResult> DownloadInCompletedReport()
    {
      try
      {
        ...
        var query = "SELECT * FROM vw_InCompletedRPT"; 
        ...
        worksheet.Cell(1, 1).InsertTable(dataTable, "InCompletedReport", true);
        ...
        return File(
          ...
          "InCompleted_Report.xlsx"
        );
      }
      catch (Exception ex)
      {
        Console.WriteLine("Error generating report: " + ex.Message);
        return StatusCode(500, new { type = "E", message = "Failed to generate InCompleted report." });
      }
    }
  }
}
